/* Theme, saved preferences, and display controls own their DOM and settings. */
(function(global) {
'use strict';
...
function saveTheme() {
        try { localStorage.setItem('bpm.theme', currentTheme); } catch (e) { /* ignore */ }
    }
...
return Object.freeze({ advSettings, advColors, canvasLabelColors, nodeHighlightColor, NET_COLORS, NET_COLOR_UNKNOWN, readSavedDisplaySettings, writeSavedDisplaySettings, saveAdvSettings, openDisplaySettingsPopup, closeDisplaySettingsPopup, init() { captureDarkDefaults(); loadAdvSettings(); loadTheme(); }, dispose() { closeDisplaySettingsPopup(); advancedDisplaySettings.close(); } });
}
global.BPMPreferences = Object.freeze({ create });
})(window);
